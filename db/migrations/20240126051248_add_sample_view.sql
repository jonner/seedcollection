CREATE VIEW IF NOT EXISTS vsamples (sampleid, tsn, parentid, srcid, srcname, srcdesc, complete_name, unit_name1, unit_name2, unit_name3, seq, quantity, month, year, notes, certainty, cnames, userid) AS
SELECT S.sampleid,
       T.tsn,
       T.parent_tsn,
       L.srcid,
