...
CREATE TABLE IF NOT EXISTS "sc_samples_new" (
...
INSERT INTO sc_samples_new SELECT sampleid, tsn, certainty, month, year, srcid, notes, CAST(quantity AS REAL), userid FROM sc_samples;
